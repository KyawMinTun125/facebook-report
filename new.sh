...
echo $i" |"$cy"     Myanmar Termux"$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" Kyaw Min Tun  [KMT]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" Kyaw Min Tun"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ အသုံးပြုရအဆင်ပြေပါစေ"$i"  |"
echo $i" |"$pu" Contack Telegram App :"$ku" @kyawmintunchk"$i"             |"
echo $i" |"$pu" Contack Viber App :"$ku" 09401565816"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
echo $i"|"$me" 1"$i" |"$cy" BRUTEFORCE FB PHP        "$i"|"$i"    |"$cy" K"$i" |"
echo $i"|"$me" 2"$i" |"$cy" BRUTEFORCE FB BR1G4D3    "$i"|"$i"    |"$cy" M"$i" |"
echo $i"|"$me" 3"$i" |"$cy" BRUTEFORCE FB iqbalz     "$i"|"$i"    |"$cy" T"$i" |"
...
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"KMT"$bi"]"$me"======"$bi"["$i""kyawmintun""$bi"]"
echo $me"¦"
read -p"└──# " pil
